...
const DirectionalLightExtended = function( opts, presets ){
    ...
    // YOu can andd objects as presets
    Presetable.initialize.call( this, presets );

};

DirectionalLightExtended.prototype = Object.assign( Object.create( THREE.DirectionalLight.prototype ),  Presetable, {
